package ru.javabegin.training.javafx.addressbook.utils;

import ru.javabegin.training.javafx.addressbook.object.Lang;
...
public class LocaleManager {
    ...
    public static void setCurreentLang(Lang currentLang) {
